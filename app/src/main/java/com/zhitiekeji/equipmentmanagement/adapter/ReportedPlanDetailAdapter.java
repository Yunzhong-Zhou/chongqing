 ...
 * 上报详情-病害列表
 */
public class ReportedPlanDetailAdapter extends BaseAdapter {
    private List<ReportedPlanDetailModel.FacilityServiceReportBean.FacilityDiseaseListBean> list;
    private Context context;
    public ReportedPlanDetailAdapter(Context context, List<ReportedPlanDetailModel.FacilityServiceReportBean.FacilityDiseaseListBean> list) {
        super();
