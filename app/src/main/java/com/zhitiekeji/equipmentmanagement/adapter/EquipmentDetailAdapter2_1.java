 ...
 * description：设备详情-adapter-大修
 */
public class EquipmentDetailAdapter2_1 extends BaseAdapter {
    private Context context;
    private List<EquipmentDetailModel2.BigBean> list;
    private int selectIndex = 0;

    public EquipmentDetailAdapter2_1(Context context, List<EquipmentDetailModel2.BigBean> list) {
        super();
