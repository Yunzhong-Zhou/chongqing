package com.zhitiekeji.equipmentmanagement.utils.jpush;
...
import com.zhitiekeji.equipmentmanagement.activity.ConstructionPlanDetailActivity;
...
//				processCustomMessage(context, bundle);
				...
				bundle1.putString("title", context.getString(R.string.information_content));
				CommonUtil.gotoActivityWithData(context, WebContentActivity.class,bundle1);*/

				//打开自定义的Activity
				Intent i = new Intent(context, ConstructionPlanDetailActivity.class);
