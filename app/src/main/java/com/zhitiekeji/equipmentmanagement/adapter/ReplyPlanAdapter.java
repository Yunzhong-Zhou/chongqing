 ...
 * description：批复计划adapter
 */
public class ReplyPlanAdapter extends BaseAdapter {
    private Context context;
    private List<ReplyPlanModel> list;
    private int selectIndex = 0;

    public ReplyPlanAdapter(Context context, List<ReplyPlanModel> list) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_replyplan, null);
        ...
        holder.textView7.setText(list.get(position).getCost_money() + "元");//下达费用
