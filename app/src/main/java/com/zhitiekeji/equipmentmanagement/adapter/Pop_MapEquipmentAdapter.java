 ...
 * description：地图弹框设备adapter
 */
public class Pop_MapEquipmentAdapter extends BaseAdapter {
    private Context context;
    private List<MapDetailModel> list;
    private int selectIndex = 0;

    public Pop_MapEquipmentAdapter(Context context, List<MapDetailModel> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_popmapequipment, null);
            ...
            holder.imageView1 = (ImageView) convertView.findViewById(R.id.imageView);
        ...
        //请检修
        holder.textView9.setText("["+list.get(position).getMinor()+"]");
        holder.textView6.setText(list.get(position).getMinor_updated_at());
        //综合维修
        holder.textView10.setText("["+list.get(position).getMid()+"]");
        holder.textView7.setText(list.get(position).getMid_updated_at());
        //大修
        holder.textView11.setText("["+list.get(position).getBig()+"]");
        holder.textView8.setText(list.get(position).getBig_updated_at());
