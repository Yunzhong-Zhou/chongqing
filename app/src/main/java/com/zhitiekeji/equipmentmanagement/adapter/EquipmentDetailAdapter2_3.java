 ...
 * description：设备详情-adapter-请检修
 */
public class EquipmentDetailAdapter2_3 extends BaseAdapter {
    private Context context;
    private List<EquipmentDetailModel2.SmallBean> list;
    private int selectIndex = 0;

    public EquipmentDetailAdapter2_3(Context context, List<EquipmentDetailModel2.SmallBean> list) {
        super();
