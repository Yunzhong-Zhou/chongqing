 ...
 * description：历年记录adapter
 */
public class CalendarYearAdapter1 extends BaseAdapter {
    private Context context;
    private List<CalendarYearModel> list;
    private int selectIndex = 0;

    public CalendarYearAdapter1(Context context, List<CalendarYearModel> list) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_calendaryear1, null);
        ...
        holder.textView7.setText(list.get(position).getActual_money()+"元");//实际金额
        holder.textView8.setText(list.get(position).getCreated_at());//竣工时间
        holder.textView9.setText(list.get(position).getEmployee().getName());//发布人
        holder.textView10.setText(list.get(position).getContent());//竣工记录
