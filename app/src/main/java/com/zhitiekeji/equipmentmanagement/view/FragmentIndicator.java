	...
	public void setIndicator(int which) {
		...
		switch(mCurIndicator) {
			case 0:
				...
				prevIcon.setImageResource(R.mipmap.tab1_0);
			...
			case 1:
				...
				prevIcon.setImageResource(R.mipmap.tab2_0);
				prevText = (TextView) mIndicators[mCurIndicator].findViewById(R.id.textView2);
				prevText.setTextColor(COLOR_UNSELECT);
				LinearLayout linearLayout = (LinearLayout) mIndicators[mCurIndicator].findViewById(R.id.linearLayout);
				linearLayout.setBackgroundResource(R.color.transparent);
				break;
			case 2:
				prevIcon =(ImageView) mIndicators[mCurIndicator].findViewById(R.id.imageView3);
				prevIcon.setImageResource(R.mipmap.tab3_0);
		...
		switch(which) {
			case 0:
				...
				currIcon.setImageResource(R.mipmap.tab1_1);
			...
			case 1:
				...
				currIcon.setImageResource(R.mipmap.tab2_1);
				currText = (TextView) mIndicators[which].findViewById(R.id.textView2);
				currText.setTextColor(getResources().getColor(R.color.white));
				LinearLayout linearLayout = (LinearLayout) mIndicators[which].findViewById(R.id.linearLayout);
				linearLayout.setBackgroundResource(R.mipmap.tab2_2);
				break;
			case 2:
				currIcon =(ImageView) mIndicators[which].findViewById(R.id.imageView3);
				currIcon.setImageResource(R.mipmap.tab3_1);
