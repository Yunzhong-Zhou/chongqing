 ...
 */
public class MyPublishingDeviceAdapter extends BaseAdapter {
    private Context context;
    private List<MyPublishingDeviceModel> list;
    private int selectIndex = 0;

    public MyPublishingDeviceAdapter(Context context, List<MyPublishingDeviceModel> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (list.get(position).getWorkshop() != null){
