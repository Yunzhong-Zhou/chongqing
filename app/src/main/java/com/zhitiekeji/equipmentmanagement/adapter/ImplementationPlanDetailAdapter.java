 ...
 * 实施详情-病害列表
 */
public class ImplementationPlanDetailAdapter extends BaseAdapter {
    private List<ImplementationPlanDetailModel.FacilityServiceReportBean.FacilityDiseaseListBean> list;
    private Context context;
    public ImplementationPlanDetailAdapter(Context context, List<ImplementationPlanDetailModel.FacilityServiceReportBean.FacilityDiseaseListBean> list) {
        super();
