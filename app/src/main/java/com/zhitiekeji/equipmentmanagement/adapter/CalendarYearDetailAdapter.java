 ...
 * 实施详情-病害列表
 */
public class CalendarYearDetailAdapter extends BaseAdapter {
    private List<CalendarYearDetailModel.FacilityServiceReportBean.FacilityDiseaseListBean> list;
    private Context context;
    public CalendarYearDetailAdapter(Context context, List<CalendarYearDetailModel.FacilityServiceReportBean.FacilityDiseaseListBean> list) {
        super();
