 ...
 *	功能描述：自定义底部工具栏
 */
public class FragmentIndicator4 extends LinearLayout implements OnClickListener {
	...
	private FragmentIndicator4(Context context) {
		super(context);
	}

	public FragmentIndicator4(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void init() {
		...
		LinearLayout ll_view = (LinearLayout) layoutInflater.inflate(R.layout.fragmentindicator4,null);
