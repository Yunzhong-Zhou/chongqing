 ...
 */
public class ImplementationPlanAdapter1 extends BaseAdapter {
    private Context context;
    private List<ImplementationPlanModel> list;
    private int selectIndex = 0;

    public ImplementationPlanAdapter1(Context context, List<ImplementationPlanModel> list) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_implementationplan1, null);
        ...
        holder.textView9.setText(list.get(position).getConstruction_company());//施工单位
        holder.textView10.setText(list.get(position).getContent());//描述
