 ...
 */
public class ReplyImplementationAdapter1 extends BaseAdapter {
    private Context context;
    private List<ReplyImplementationModel> list;
    private int selectIndex = 0;

    public ReplyImplementationAdapter1(Context context, List<ReplyImplementationModel> list) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_replyimplementation1, null);
        ...
        holder.textView7.setText(list.get(position).getAmount_money()+"元");//技物科批复费用
        holder.textView8.setText(list.get(position).getProject_scope());//工程范围
