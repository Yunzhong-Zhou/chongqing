 ...
 * 请检修详情-病害列表
 */
public class PleaseOverhaulDetailAdapter extends BaseAdapter {
    private List<PleaseOverhaulDetailModel.FacilityServiceApplyBean.FacilityDiseaseListBean> list;
    private Context context;
    public PleaseOverhaulDetailAdapter(Context context, List<PleaseOverhaulDetailModel.FacilityServiceApplyBean.FacilityDiseaseListBean> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        }else if (list.get(position).getDegree()== 4){
            holder.textView5.setText("严重");
        }else if (list.get(position).getDegree()== 5){
