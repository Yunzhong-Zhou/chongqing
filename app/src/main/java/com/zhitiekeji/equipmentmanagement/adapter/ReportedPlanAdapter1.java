 ...
 * description：上报计划adapter
 */
public class ReportedPlanAdapter1 extends BaseAdapter {
    private Context context;
    private List<ReportedPlanModel> list;
    private int selectIndex = 0;

    public ReportedPlanAdapter1(Context context, List<ReportedPlanModel> list) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_reportedplan1, null);
...
//            MyLogger.i(">>>>>>>>"+list.get(position).getFacility_service_report().getFacility_disease_list().get(i).getTitle());
