 ...
 * 上报详情-病害列表
 */
public class ReplyPlanDetailAdapter extends BaseAdapter {
    private List<ReplyPlanDetailModel.FacilityServiceReportBean.FacilityDiseaseListBean> list;
    private Context context;
    public ReplyPlanDetailAdapter(Context context, List<ReplyPlanDetailModel.FacilityServiceReportBean.FacilityDiseaseListBean> list) {
        super();
